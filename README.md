...
Sales for Aicountly — a React single-page app built with Vite and TypeScript,
with a small PHP API alongside it. Both halves deploy to cPanel.

| Environment | App | API |
| --- | --- | --- |
| Production | https://sales.aicountly.com | https://sales.aicountly.com/api |
| Sandbox | https://sales.gh.aicountly.com | https://sales.gh.aicountly.com/api |
...
(`https://sales.gh.aicountly.com/api`) so the token exchange has somewhere to
