 ...
 * sales.aicountly.com and sales.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'sales').trim() || 'sales'
...
/**
 * `sales.aicountly.com` and `sales.gh.aicountly.com` both resolve to
 * `sales`, which is what the portal expects in authentication_jump.
 */
