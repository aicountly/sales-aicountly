...
$pdo->exec(
    'CREATE TABLE IF NOT EXISTS sales_sql_migrations (
...
$applied = [];
foreach (Db::all('SELECT filename, checksum FROM sales_sql_migrations') as $row) {
...
foreach ($files as $path) {
    ...
    try {
        ...
        $stmt = $pdo->prepare('INSERT INTO sales_sql_migrations (filename, checksum) VALUES (:f, :c)');
